...
The next step after retention time correction is the grouping of corresponding features in multiple samples. The used method is tolerant against local swaps in elution order.
