...
\begin{itemize}
\item
Nodes for signal and data processing, filtering and data reduction. Here, files are passed between nodes. Execution times of the individual steps are typicallz longerfor these type of nodes as they perform the main computations. 
\item
