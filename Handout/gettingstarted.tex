...
\newcommand{\KnimeTrunkSite}{http://update.knime.com/community-contributions/trunk}
...
Now restart KNIME.
\newline \newline
Install R from https://www.r-project.org. Open it and run
\begin{lstlisting}[aboveskip=8pt]
install.packages("Rserve")
source("http://bioconductor.org/biocLite.R")
biocLite("MSstats")
\end{lstlisting}
Then open  KNIME, click on \menu{KNIME > Preferences}, select the category \menu{KNIME > R} and set the "Path to R Home" to your installation path.
