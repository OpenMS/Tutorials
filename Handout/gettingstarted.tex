...
\newcommand{\WindowsKnimeInstallerName}{Windows / KNIME\ 4.0.0\ Installer\ (64bit).exe}	
...
\newcommand{\MacKnimeInstallerName}{Mac / knime\_4.0.0.app.macosx.cocoa.x86\_64.dmg}	
\newcommand{\MacOpenMSInstallerName}{Mac / OpenMS-2.4.0-macOS.dmg}
\newcommand{\KnimeUpdateSite}{http://update.knime.com/analytics-platform/4.0}
\newcommand{\KnimeTrustedSite}{http://update.knime.com/community-contributions/trusted/4.0}
