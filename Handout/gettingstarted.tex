...
\note{If you installed a KNIME installer that contains all community contributions, or you received the full installer on our USB Stick you can skip this section. This is usually the preferred way but only works for stable releases. For bleeding edge functionality (as provided as nightly community contributions or in the case we cover prereleases of OpenMS) you need to perform the steps indicated below.}
