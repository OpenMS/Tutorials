...
\newcommand{\WindowsKnimeInstallerName}{Windows / KNIME\ Full\ 3.4.1\ Installer\ (64bit).exe}	
...
\newcommand{\MacKnimeInstallerName}{Mac / knime-full\_3.4.1.app.macosx.cocoa.x86\_64.dmg}	
\newcommand{\MacOpenMSInstallerName}{Mac / OpenMS-2.3.0\_Mac.dmg}
...
\begin{itemize}
\item Start \OPENMSTOOL{TOPPView} (see Windows' Start-Menu or \directory{Applications/OpenMS} on macOS)
