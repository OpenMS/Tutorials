...
An example KNIME workflow for OpenSWATH is supplied in \directory{Workflows/} (Figure~\ref{fig:openswath}). The example dataset can be used for this workflow (filenames in brackets):
