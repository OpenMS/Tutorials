...
\item All sample data referenced in this tutorial can be found in the \directory{C: / Example\_Data} folder, on the USB stick that came with this tutorial , or released online on our GitHub page
