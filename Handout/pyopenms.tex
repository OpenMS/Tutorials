...
Just like every python method you can inspect arguments and documentation of pyopenms methods using dir and help if you need more information:

\begin{lstlisting}
>>>dir(pyopenms.FileHandler())
['__class__', '__delattr__', '__doc__', '__format__', '__getattribute__', '__hash__', '__init__', '__new__', '__reduce__', '__reduce_ex__', '__repr__', '__setattr__', '__sizeof__', '__str__', '__subclasshook__', '_init_0', '_init_1', 'computeFileHash', 'getOptions', 'getType', 'getTypeByContent', 'getTypeByFileName', 'hasValidExtension', 'isSupported', 'loadExperiment', 'loadFeatures', 'setOptions', 'storeExperiment']

>>>help(pyopenms.FileHandler())
Help on FileHandler object:

class FileHandler(__builtin__.object)
 ...
 |      - Cython signature: void FileHandler(FileHandler)
 |  
 |  getOptions(...)
 |      Cython signature: PeakFileOptions getOptions()
 |  
 |  loadExperiment(...)
 |      Cython signature: bool loadExperiment(libcpp_string, MSExperiment &)
 |  
 |  loadFeatures(...)
 |      Cython signature: bool loadFeatures(libcpp_string, FeatureMap &)
 |  
 |  setOptions(...)
 |      Cython signature: void setOptions(PeakFileOptions)
 |  
 |  storeExperiment(...)
 |      Cython signature: void storeExperiment(libcpp_string, MSExperiment)
 |  
(...)
\end{lstlisting}
