...
\subsubsection{Advanced data analysis in KNIME using MSstats}
...
The quantitative analysis can be performed using MSstats. In this case an experimental design has to specified for the OpenMS workflow (see \ref{Experimental_design}).
