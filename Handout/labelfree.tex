...
\paragraph{Rename results}

%TODO if possible update picture to reflect complete workflow
%TODO renaming part
%TODO export part
%TODO short interpretation of the first volcano plot

%test.MSstats <- groupComparison(contrast.matrix=comparison, data=processed.quant)

A complete premade workflow can be found under \directory{Workflows/ MSstats\_statPostProcessing\_iPRG2015.knwf}.
