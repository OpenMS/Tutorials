...
\end{itemize}
Choose the installers for the platform you are working on. We suggest to use the full installers so that you can skip the installation of the OpenMS plugin and other dependencies for the example workflows.
...
\hyperref{https://tech.knime.org/knime}{Getting Started page}. However,
...
zip files can be found on our \hyperref{https://github.com/OpenMS/Tutorials}{GitHub repository}.
